...
ALTER TABLE KHUYENMAIDONHANG ADD CONSTRAINT PK_DISC PRIMARY KEY (ID_DON,ID_KM);
...
--bang KHUYENMAIDONHANG

ALTER TABLE KHUYENMAIDONHANG ADD CONSTRAINT FK_DISCOUNT_DON_HANG 
    FOREIGN KEY (ID_DON) REFERENCES DON_HANG(ID);

ALTER TABLE KHUYENMAIDONHANG ADD CONSTRAINT FK_DISCOUNT_CHUONG_TRINH_KM 
    FOREIGN KEY (ID_KM) REFERENCES CHUONG_TRINH_KM(ID);
