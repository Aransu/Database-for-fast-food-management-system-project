...
--------------------------------------------------------------------------------
INSERT INTO NGUYEN_LIEU(ID, TEN, DON_VI, SO_LUONG_TRONG_KHO) 
VALUES (1, 'Thịt bò', 'gram', 1000);

INSERT INTO NGUYEN_LIEU(ID, TEN, DON_VI, SO_LUONG_TRONG_KHO) 
VALUES (2, 'Rau', 'gram', 2000);

INSERT INTO NGUYEN_LIEU(ID, TEN, DON_VI, SO_LUONG_TRONG_KHO) 
VALUES (3, 'Sốt', 'chai', 10);

INSERT INTO NGUYEN_LIEU(ID, TEN, DON_VI, SO_LUONG_TRONG_KHO) 
VALUES (4, 'Bột nở', 'gram', 500);

INSERT INTO NGUYEN_LIEU(ID, TEN, DON_VI, SO_LUONG_TRONG_KHO) 
VALUES (5, 'Thịt xúc xích', 'gram', 1500);

INSERT INTO NGUYEN_LIEU(ID, TEN, DON_VI, SO_LUONG_TRONG_KHO) 
VALUES (6, 'Thịt hun khói', 'gram', 1000);

INSERT INTO NGUYEN_LIEU(ID, TEN, DON_VI, SO_LUONG_TRONG_KHO) 
VALUES (7, 'Rau trộn', 'gram', 3000);

INSERT INTO NGUYEN_LIEU(ID, TEN, DON_VI, SO_LUONG_TRONG_KHO) 
VALUES (8, 'Sốt cà chua', 'chai', 20);

INSERT INTO NGUYEN_LIEU(ID, TEN, DON_VI, SO_LUONG_TRONG_KHO) 
VALUES (9, 'Gà', 'con', 50);

INSERT INTO NGUYEN_LIEU(ID, TEN, DON_VI, SO_LUONG_TRONG_KHO) 
VALUES (10, 'Bột chiên xù', 'gram', 1000);

INSERT INTO NGUYEN_LIEU(ID, TEN, DON_VI, SO_LUONG_TRONG_KHO) 
VALUES (11, 'Khoai tây', 'gram', 5000);
--------------------------------------------------------------------------------
-- Hamburger
