...
CREATE TABLE KH_AN_TAI_QUAN(
    ID_KH INT NOT NULL PRIMARY KEY
);

CREATE TABLE KH_DAT_ONLINE(
    ID_KH INT NOT NULL PRIMARY KEY
);
...
CREATE TABLE DIA_CHI_KHACH_HANG(
    ID_DC VARCHAR(50) NOT NULL,
    ID_KH VARCHAR(50) NOT NULL
);

ALTER TABLE DIA_CHI_KHACH_HANG ADD CONSTRAINT PK_DCKH PRIMARY KEY (ID_DC,ID_KH)
...
ALTER TABLE DISCOUNT ADD CONSTRAINT PK_DISC PRIMARY KEY (ID_DON,ID_KM);
...
ALTER TABLE DON_MON ADD CONSTRAINT PK_DM PRIMARY KEY (ID_DON,ID_MON);
...
CREATE TABLE NV_QUAN_LY(
    ID_NV INT NOT NULL PRIMARY KEY
);

CREATE TABLE NV_THU_NGAN(
    ID_NV INT NOT NULL PRIMARY KEY
);
...
--khoa ngoai
--bang khach hang
ALTER TABLE KH_AN_TAI_QUAN ADD CONSTRAINT FK_KH_AN_TAI_QUAN_KHACH_HANG 
    FOREIGN KEY (ID_KH) REFERENCES KHACH_HANG(ID);
ALTER TABLE KH_DAT_ONLINE ADD CONSTRAINT FK_KH_DAT_ONLINE_KHACH_HANG 
    FOREIGN KEY (ID_KH) REFERENCES KHACH_HANG(ID);
--bang dia chi khach hang
ALTER TABLE DIA_CHI_KHACH_HANG ADD CONSTRAINT FK_DIA_CHI_KHACH_HANG_KHACH_HANG 
    FOREIGN KEY (ID_KH) REFERENCES KHACH_HANG(ID);
ALTER TABLE DIA_CHI_KHACH_HANG ADD CONSTRAINT FK_DIA_CHI_KHACH_HANG_DIA_CHI_GIAO_HANG 
    FOREIGN KEY (ID_DC) REFERENCES DIA_CHI_GIAO_HANG(ID);
--bang don hang
...
ALTER TABLE DON_HANG ADD CONSTRAINT FK_DON_HANG_NV_THU_NGAN 
    FOREIGN KEY (ID_THU_NGAN) REFERENCES NV_THU_NGAN(ID_NV);
--bang discount

ALTER TABLE DISCOUNT ADD CONSTRAINT FK_DISCOUNT_DON_HANG 
    FOREIGN KEY (ID_DON) REFERENCES DON_HANG(ID);

ALTER TABLE DISCOUNT ADD CONSTRAINT FK_DISCOUNT_CHUONG_TRINH_KM 
    FOREIGN KEY (ID_KM) REFERENCES CHUONG_TRINH_KM(ID);
--bang don mon
ALTER TABLE DON_MON ADD CONSTRAINT FK_DON_MON_DON_HANG 
    FOREIGN KEY (ID_DON) REFERENCES DON_HANG(ID);

ALTER TABLE DON_MON ADD CONSTRAINT FK_DON_MON_MON_AN 
...
ADD CONSTRAINT FK_NV_QL FOREIGN KEY (ID_QUAN_LY)
REFERENCES  NV_QUAN_LY(ID_NV);
...
ALTER TABLE NHACUNGCAP_NGUYENLIEU_QUANLY_BEP
ADD CONSTRAINT FK_BEP
FOREIGN KEY (ID_BEP)
REFERENCES NV_BEP(ID_NV);
